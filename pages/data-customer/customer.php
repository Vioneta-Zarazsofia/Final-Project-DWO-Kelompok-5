            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="../../pages/data-customer/customer.php">
                        <span class="menu-icon">
                            <i class="mdi mdi-chart-bar bg-danger"></i>
                        </span>
        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper bg-light">
                <div class="page-header">
                    <h3 class="page-title text-dark" style="font-size:20px;"> <br> Data Pembelian Customer </h3>
                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description text-dark" style="font-size:14px; text-align:center;"> <br>
                        Customer yang melakukan pembelian produk terbanyak. Customer dengan ID 676 melakukan pembelian
                        sebanyak 6.0$
                    </p>
