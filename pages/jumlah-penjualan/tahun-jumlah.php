...
<body>
  ...
  ?>
    <div class="container-scroller style="background-color: #8FBC8F;">
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item" > <a class="nav-link text-black" href="../../pages/data-penjualan/tahun.php">Berdasarkan Tahun</a>
                            </li>
                        </ul>
                    </div>
                </li>
        ...
        <div class="container-fixed page-body-wrapper">
            <div class="bg-light content-wrapper">
                <div class="page-header">
                    <h3 class="page-title text-dark" style="font-size:25px;"> <br> Data Order Penjualan Produk
                        Berdasarkan
                        Tahun </h3>
                </div>
                <div class="row">
                    ...
                    <p class="highcharts-description text-dark" style="font-size:14px; text-align:center;"><br>
                        Jumlah order pada tahun 2002 dan 2003 sama
                    </p>
